...
with tab3:
    ...
    # Use st.data_editor instead of st.grid
    edited_kpi_table = st.data_editor(kpi_table, height=400)  # Allows editing and displays the DataFrame
    # Download button for the edited table
    st.download_button("Descargar como CSV", edited_kpi_table.to_csv(index=False).encode('utf-8'), "kpis_detallados.csv", "text/csv")
